      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarAtlas">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link"
                href="${pageContext.request.contextPath}/librarian/action?action=removeBook">Remover</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"
                href="${pageContext.request.contextPath}/librarian/action?action=searchBooks">Buscar</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"
                href="${pageContext.request.contextPath}/librarian/action?action=manageAuthors">Autores</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"
                href="${pageContext.request.contextPath}/librarian/action?action=manageCategory">Categorias</a>
            </li>
            <li class="nav-item">
              <a class="nav-link"
                href="${pageContext.request.contextPath}/librarian/action?action=addCopies">Exemplares</a>
            </li>
          </ul>
