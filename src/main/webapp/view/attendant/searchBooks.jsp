...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Work+Sans:wght@400;500;600&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet">
  ...
  <link rel="stylesheet"
        href="${pageContext.request.contextPath}/assets/css/admin/navbarAdm.css"/>

  <link rel="stylesheet"
        href="${pageContext.request.contextPath}/assets/css/librarian/searchBooks.css"/>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse"
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link"
               href="${pageContext.request.contextPath}/view/attendant/clients.jsp">
              Clientes
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link"
               href="${pageContext.request.contextPath}/view/attendant/loan.jsp">
              Empréstimo
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link active"
               href="${pageContext.request.contextPath}/view/attendant/searchBooks">
              Buscar Livros
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link"
               href="${pageContext.request.contextPath}/view/attendant/activeLoans.jsp">
              Empréstimos Ativos
            </a>
          </li>
        </ul>
...
<main class="container-fluid books-container">
  ...
  <section class="titulo-section">
    <h1>
      Visualizar e buscar livros no acervo do sistema
    </h1>
    <p>
      Consulta de Acervo
    </p>
  ...
  <section class="search-box">
    ...
    <form action="${pageContext.request.contextPath}/searchBooks"
          method="get">
    ...
    <% if (books != null && !books.isEmpty()) { %>
      ...
      <% for (Book book : books) { %>
        ...
        <div class="book-card">
          ...
          <a href="${pageContext.request.contextPath}/viewBook?id=<%= book.getBookId() %>"
             class="book-view">
            Ver
          </a>
        </div>
