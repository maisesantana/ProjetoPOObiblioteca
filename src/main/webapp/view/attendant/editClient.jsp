...
<head>
  ...
  <title>Atlas - Editar Cliente</title>
...
<body>
  ...
  <main class="container-fluid form-container">
    <nav class="breadcrumb-custom">
      ...
      <span>/</span>
      <a href="${pageContext.request.contextPath}/clients?action=profile&cpf=<%= client.getCpf() %>"><%= client.getName() %></a>
      <span>/</span>
    ...
    <form action="${pageContext.request.contextPath}/clients" method="post">
      ...
      <div class="form-group">
        <label>CPF</label>
        <input type="text" value="<%= client.getCpf() %>" disabled/>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <select id="gender" name="gender" required>
          <option value="M" <%= client.getGender() == 'M' ? "selected" : "" %>>Masculino</option>
          <option value="F" <%= client.getGender() == 'F' ? "selected" : "" %>>Feminino</option>
          <option value="O" <%= client.getGender() == 'O' ? "selected" : "" %>>Outro</option>
        </select>
      </div>
      <div class="form-group">
        <label for="birthDate">Data de nascimento</label>
        <input type="date" id="birthDate" name="birthDate" value="<%= client.getBirthDate() %>" required/>
      </div>
      <div class="form-group">
      ...
      <div class="form-actions">
        ...
        <a href="${pageContext.request.contextPath}/clients?action=profile&cpf=<%= client.getCpf() %>" class="btn-cancel-link">Cancelar</a>
      </div>
    </form>
  </main>
