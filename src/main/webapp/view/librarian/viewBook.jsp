  ...
  <%@ page import="br.com.atlas.model.Librarian" %>
    <%@ page import="br.com.atlas.model.Book" %>
      ...
      <% Object user=session.getAttribute("userLogged"); if(user==null || !(user instanceof Librarian || user instanceof
        ...
        availableCopies=book.totalAvailableCopies(); // PEGA A ORIGEM QUE VEIO DO CONTROLLER (busca ou lista) String
        origem=(String) request.getAttribute("origem"); if (origem==null) { origem="busca" ; // Caso venha vazio, define
        um padrão seguro } %>
          ...
          <body>
            ...
            <main class="container-fluid view-container">
              <nav class="breadcrumb-custom">
                ...
                <%-- IF DA ORIGEM NO BREADCRUMB --%>
                  <% if (origem.equals("lista")) { %>
