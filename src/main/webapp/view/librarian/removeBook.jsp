      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarAtlas">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/removeBook">Remover</a></li>
        ...
        <% for (Book book : books) { %>
          <div class="book-card">
            ...
            <form action="${pageContext.request.contextPath}/removeBook" method="post"
              ...
              <button type="submit" class="btn-remove"><i class="bi bi-trash"></i> Remover</button>
            </form>
          </div>
        <% } %>
      <% } else if (books != null) { %>
