...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarAtlas">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="${pageContext.request.contextPath}/removeBook">Remover</a>
            </li>
            <li class="nav-item">
  ...
  <main class="container-fluid remove-container">
    ...
    <div class="toast-success <%= "book_removed".equals(msg) ? "show" : "" %>" id="toastSuccess">
      ...
      <% if (books != null && !books.isEmpty()) { %>
        <% for (Book book : books) { %>
          <div class="book-card">
            ...
            <%-- Formulário de remoção individual por livro --%>
            <form action="${pageContext.request.contextPath}/removeBook" method="post"
                  onsubmit="return confirm('Tem certeza que deseja remover o livro \'<%= book.getBookName() %>\'?')">
