...
<body>
  ...
  <main class="container-fluid categories-container">
    ...
    <div class="toast-msg toast-success <%= "category_added".equals(msg) ? "show" : "" %>"><i class="bi bi-check-circle-fill"></i> Categoria cadastrada com sucesso!</div>
    <div class="toast-msg toast-success <%= "category_updated".equals(msg) ? "show" : "" %>"><i class="bi bi-check-circle-fill"></i> Alterações salvas com sucesso!</div>
    <div class="toast-msg toast-success <%= "category_deleted".equals(msg) ? "show" : "" %>"><i class="bi bi-check-circle-fill"></i> Categoria removida com sucesso!</div>
    <div class="toast-msg toast-error <%= "error".equals(msg) ? "show" : "" %>"><i class="bi bi-exclamation-circle-fill"></i> Erro ao processar a requisição.</div>
