                        ...
                        <% } else if ("error".equals(msg)) { %>
                          ...
                          < class="container mt-3">
                            <% }if ("category_exists".equals(msg)) { %>
                              ...
                              <% } else if ("category_added".equals(msg)) { %>
                          ...
                          <div class="tabs">
                            <button type="button" class="tab-btn" data-target="register">Cadastrar
                              categoria</button>
                                    ...
                                    <% for (Category cat : categories) { %>
                                      <div class="category-card" id="card-<%= cat.getCategoryId() %>">
                                        ...
                                        <div class="category-info">
                                          ...
                                          <form action="${pageContext.request.contextPath}/manageCategory" method="post"
                                            ...
                                            <input type="hidden" name="query"
                                              value="${param.query != null ? param.query : ''}">
                                            <input type="text" name="categoryName" value="<%= cat.getCategoryName() %>"
                                              required>
                                        ...
                                        <form action="${pageContext.request.contextPath}/manageCategory" method="post"
                                          ...
                                          <input type="hidden" name="query"
                                            value="${param.query != null ? param.query : ''}">
                                          <button type="submit" class="btn-delete-link"><i
