          ...
          <%@ page import="java.util.ArrayList" %>
            <%@ page import="java.sql.Connection" %>
              ...
              <% Object user=session.getAttribute("userLogged"); if(user==null || !(user instanceof Librarian)){
                response.sendRedirect(request.getContextPath() + "/view/index.jsp?msg=unauthorized" ); return; }
                  ...
                  <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false" %>
                    ...
                    <head>
                      ...
                      <style>
                        ...
                        .btn-finalizar:hover {
                          background-color: #6690d8;
                          transform: translateY(-2px);
                          box-shadow: 0 4px 12px rgba(128, 164, 237, 0.3);
                        }
                    ...
                    <body>
                          ...
                          <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarAtlas">
                              <ul class="navbar-nav me-auto">
                                ...
                                <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/view/librarian/removeBook.jsp">Remover</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/view/librarian/addCopies.jsp">Exemplares</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/view/librarian/searchBooks.jsp">Buscar</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/view/librarian/manageAuthors.jsp">Autores</a>
                                </li>
                                <li class="nav-item"><a class="nav-link"
                                    href="${pageContext.request.contextPath}/view/librarian/manageCategory.jsp">Categorias</a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="${pageContext.request.contextPath}/bookList">Lista de
                                    livros</a>
                                </li>
                              </ul>
                      ...
                      <main class="container py-4">
                        ...
                        <nav class="breadcrumb-atlas mb-4">
                          ...
                          <span> / </span>
                          <span style="color: #6B1A2B; font-weight: bold;">Cadastrar livro</span>
                        </nav>
                          ...
                          <% if ("book_added".equals(msg)) { %>
                            ...
                            <% } else if (msg !=null && msg.contains("error")) { %>
                              <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                Erro: <%= request.getParameter("detail") !=null ? request.getParameter("detail")
                                  : "Falha ao cadastrar." %>
                                  <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                              </div>
                              <% } %>
                                ...
                                <div class="row justify-content-center">
                                  <div class="col-lg-7">
                                    <form action="${pageContext.request.contextPath}/librarian/action" method="post"
                                      class="row g-4">
                                      ...
                                      <div class="col-12">
                                        ...
                                        <div id="newCategoryDiv">
                                          <input type="text" id="newCategoryName" name="newCategoryName"
                                            class="form-control mt-2" placeholder="Digite o nome da nova categoria" />
                                        </div>
                                      </div>
                      ...
                      <footer class="text-center py-4 mt-5 text-muted"
                        style="font-size: 0.8rem; border-top: 1px solid #eee;">
