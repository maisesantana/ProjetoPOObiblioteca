...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/librarian/registerBook.css" />
</head>
        ...
        <form action="${pageContext.request.contextPath}/librarian/action" method="post" class="row g-4">
          ...
          <div class="col-12">
            ...
            <div id="newCategoryDiv">
              <input type="text" id="newCategoryName" name="newCategoryName" class="form-control mt-2" placeholder="Digite o nome da nova categoria" />
            </div>
          </div>
