<%@ page import="br.com.atlas.model.Librarian" %>
    ...
    <% Object user=session.getAttribute("userLogged"); if(user==null || !(user instanceof Librarian)){
        response.sendRedirect(request.getContextPath() + "/view/index.jsp?msg=unauthorized" ); return; } Librarian
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarAtlas">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="${pageContext.request.contextPath}/removeBook">Remover</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="${pageContext.request.contextPath}/addCopies">Exemplares</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="${pageContext.request.contextPath}/searchBooks">Buscar</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="${pageContext.request.contextPath}/manageAuthors">Autores</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link"
                                            href="${pageContext.request.contextPath}/manageCategory">Categorias</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <main class="col-12 pt-4 px-5">
                            <section class="ferramentas-admin">
                                ...
                                <div class="ferramentas-titulo">
                                    ...
                                    <h2>Olá, <%= librarian.getName() %>! O que deseja fazer?</h2>
                                </div>

                                <div class="row justify-content-center text-center g-5">

                                    <div class="col-lg-4 col-md-6">
                                        <a href="${pageContext.request.contextPath}/view/librarian/registerBook.jsp"
                                            class="tool-card">
                                            <div class="tool-icon">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <a href="${pageContext.request.contextPath}/addCopies" class="tool-card">
                                            <div class="tool-icon">
