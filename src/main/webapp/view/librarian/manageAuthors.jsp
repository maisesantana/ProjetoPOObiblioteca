              ...
              <body>
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                          ...
                          <li class="nav-item">
                            <a class="nav-link active"
                              href="${pageContext.request.contextPath}/manageAuthors?tab=register">Autores</a>
                          </li>
                          <li class="nav-item">
                        ...
                        <% } else if ("error".equals(msg)) { %>
                          ...
                          <% } else if ("name_empty".equals(msg)) { %>
                            ...
                            <% } %>
                              ...
                              <%-- Abas: Espaços removidos de dentro das aspas do equals --%>
                                <div class="tabs">
                                  <button type="button" class="tab-btn <%= " register".equals(activeTab) ? "active" : ""
                                    %>" data-target="register">Cadastrar autor</button>
                                  <button type="button" class="tab-btn <%= " edit".equals(activeTab) ? "active" : "" %>"
                                    data-target="edit">Editar autores</button>
                                </div>

                                <%-- ABA: CADASTRAR --%>
                                  <div class="tab-panel <%= " register".equals(activeTab) ? "active" : "" %>"
                                    id="panel-register">
                                    <div class="form-card">
                                  ...
                                  <%-- ABA: EDITAR --%>
                                    <div class="tab-panel <%= " edit".equals(activeTab) ? "active" : "" %>"
                                      id="panel-edit">
                                                  ...
                                                  <%-- Formulário de edição inline --%>
                                                    <form class="edit-form" id="form-<%= author.getAuthorId() %>"
                                                      ...
                                                      <button type="button" class="btn-cancel"
                                                        data-id="<%= author.getAuthorId() %>">Cancelar</button>
                                                    </form>
                ...
                <script>
                  document.addEventListener("DOMContentLoaded", function () {
                    ...
                    // Gerenciamento de Abas via Event Listeners do JavaScript
