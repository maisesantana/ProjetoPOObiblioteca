      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarAtlas">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/manageAuthors?tab=register">Autores</a></li>
    ...
    <div class="tab-panel" id="panel-edit">
      <section class="search-box">
        <form action="${pageContext.request.contextPath}/manageAuthors" method="get">
          ...
          <input type="text" name="query" placeholder="Digite o nome do autor para buscar..." value="${param.query != null ? param.query : ''}">
