        ...
        <%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" isELIgnored="false" %>
            <%@ page import="java.util.List" %>
                <%@ page import="br.com.atlas.model.Book" %>
                    <% List<Book> books = (List<Book>) request.getAttribute("books");
                            ...
                            <head>
                                ...
                                <link rel="stylesheet"
                                    href="${pageContext.request.contextPath}/assets/css/librarian/bookList.css" />
                                <link rel="stylesheet"
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="collapse navbar-collapse" id="navbarAtlas">
                                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link"
                                                            href="${pageContext.request.contextPath}/bookList">Lista de
                                                            livros</a>
                                                    </li>
                                                </ul>
              ...
              <div class=" book-actions">
                                                ...
                                                <% } %>
                                                    <% } else { %>
                                                        <p class="text-muted text-center py-4">Nenhum livro encontrado
                                                            no acervo.</p>
                                                        <% } %>
                                    </section>
                                </main>
