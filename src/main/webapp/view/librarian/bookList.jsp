...
<%
    ...
    if (userLogged == null || !(userLogged instanceof Librarian)) {
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarAtlas">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/bookList">Lista de livros</a></li>
          </ul>
